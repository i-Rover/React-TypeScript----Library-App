            ...
            <div className="mt-5">
                ...
                <nav>
                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        aria-controls="nav-messages" aria-selected="true">
                            Messages
                        </button>  
                    </div>
                </nav>
                <div className="tab-content" id='nav-tabContent'>
                    <div className="tab-pane fade show active" id="nav-add-book" role="tabpanel" aria-aria-labelledby="nav-add-book-tab">
                        <AddNewBook />
                    </div>
