...
export const AddNewBook = () => {
    ...
    //Submit File & Book
    const [isAddNewBookLoading, setIsAddNewBookLoading] = useState(false);
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                ...
                                <ul id="addNewBookId" className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><a onClick={() => categoryField('BE')} className="dropdown-item">BE</a></li>
